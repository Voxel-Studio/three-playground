        ...
        <div className={styles.aboutWrapper}>
          ...
          >
            <div
              ...
              style={{ backgroundImage: `url(/images/3.4-a.jpg)` }}
            />
          </div>
          ...
          <div className={`${styles.row} section`}>
            <div className={`${styles.fullImg}`}>
              <div style={{ backgroundImage: `url(/images/3.8.jpg)` }} />
            </div>
          </div>
          <div
            id='second'
          ...
          <div className={`${styles.row} ${styles.rowImages} section`}>
            <div id='smallImageContainer' className={`${styles.fullImg}`}>
              <div style={{ backgroundImage: `url(/images/3.13.jpg)` }} />
            </div>
            <div id='smallImageContainer' className={`${styles.fullImg}`}>
              <div style={{ backgroundImage: `url(/images/3.12.jpg)` }} />
            </div>
          </div>
          <video
            src='/videos/3.14.mp4'
