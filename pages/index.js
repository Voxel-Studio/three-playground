                ...
                <div className={styles.homeWrapper}>
                    ...
                    <div className={`${styles.row} section`}>
                        <div className={`${styles.fullImg}`}>
                            <div
                                style={{
                                    backgroundImage: `url(/images/2.14.jpg)`,
                                }}
                            />
                            {/* <video
                    ...
                    >
                        ...
                        <div className={styles.logoGrid} ref={logoRef}>
                            ...
                            <img src="/images/logo-bmw.svg" alt="" />
                    ...
                    >
                        <div className={styles.contentLeft}>
                            ...
                            <p id="thirdSplit">
                                At Insert Productions, we take great pride in
                                our client-centric approach. We believe that the
                                success of our clients is our success, and we
                                are committed to forming strong, collaborative
                                partnerships and working closely with them to
                                deliver exceptional value and achieve mutual
                                goals. Our client list speaks volumes. From our
                                inception, we have represented a diverse
                                spectrum of brands, spanning from startups to
                                World-renowned enterprises, all underpinned by
                                the same dedicated partnership approach. Every
                                day has seen us wholeheartedly committing our
                                expertise and passion to our clients, resulting
                                in remarkable successes and the cultivation of
