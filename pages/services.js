        ...
        <div className={styles.aboutWrapper}>
          ...
          >
            <div id='first' className={styles.contentLeft}>
              ...
              <p id='firstSplit'>
                Captivate Your Audience: Transforming Moments into Unforgettable
                Live Event Experiences! In a time where more often that not we
                are working apart, a live event offers that crucial time to
                showcase your product and bring people together
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div id='second' className={styles.contentLeft}>
              ...
              <p id='secondSplit'>
                These virtual gatherings break down geographical barriers,
                allowing you to reach a global audience with ease. Imagine the
                potential for brand exposure, lead generation, and networking
                opportunities—all from the comfort of your digital device.
              </p>
            </div>
          </div>
              ...
              <div className={`${styles.contentFull} section`}>
                <div>
                  <h1 style={{ fontSize: '3rem' }}>
                    Elevate Your Experience with Our Virtual Events
                  </h1>
                  <ul>
          ...
          >
            <div id='third' className={styles.contentLeft}>
              ...
              <p id='thirdSplit'>
                In the ever-evolving landscape of modern business and
                engagement, digital events have become not only relevant but
                crucial to success. As we navigate a world that increasingly
                values connectivity and accessibility, the significance of
                digital events cannot be overstated.
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div id='fourth' className={styles.contentLeft}>
              ...
              <p id='fourthSplit'>
                Step into a realm of unparalleled engagement and immersive
                moments with our experiential events. We redefine traditional
                gatherings, offering not just events but unforgettable
